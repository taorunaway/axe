define(['jquery','underscore','backbone','app/models/article','app/models/articles','text!htmls/article_push_query.html','pageTemplate','button','modal'],function($,_,Backbone,Model,Collection,queryHtml,pageTemp,Button,modal){
    var View  =  Backbone.View.extend({
        el:'#article_push_view',
        initialize:function(){
